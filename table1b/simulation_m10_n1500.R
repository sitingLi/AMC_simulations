...
for (j in 1:simu_times){
  ...
  # generate data
  data=simu(size = 1500, nvariate = 10, prob = c(0.4, 0.3, 0.2, 0.1), mu=c(1, 2, 3, 4), 
  ...
  newdata <- dummy_obs[,11:40] # X1-X10 (categorized by amc) are transformed to dummy variables
  ...
  obs <- dummy_obs[, 11:40]  # X1-X5 (categorized into quantiles) are transformed to dummy variables
